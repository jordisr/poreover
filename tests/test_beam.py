...
class beam_2d_toy(unittest.TestCase):
    ...
    def test_same(self):
        ...
        result_2d = decoding.decoding_cpp.cpp_beam_search_2d_by_row(np.log(y), np.log(y), alphabet_="AB")
    ...
    def test_full_envelope(self):
        ...
        full_seq = decoding.decoding_cpp.cpp_beam_search_2d_by_row(np.log(y1), np.log(y2), alphabet_="AB")
...
class beam_2d_same(unittest.TestCase):
    ...
    def test_same(self):
        ...
        result_2d = decoding.decoding_cpp.cpp_beam_search_2d_by_row(y, y)
        print(result_1d, result_2d, decoding.prefix_search_log(y))
        #self.assertTrue(result_1d == result_2d)

    def test_full_envelope(self):
        full_seq = decoding.decoding_cpp.cpp_beam_search_2d_by_row(self.model.log_prob, self.model.log_prob)
        envelope_ranges = np.tile([0, self.t_max-1], (self.t_max, 1))
        full_envelope_seq = decoding.decoding_cpp.cpp_beam_search_2d_by_row(self.model.log_prob, self.model.log_prob, envelope_ranges.tolist())
    ...
    def test_diagonal_envelope(self):
        ...
        result_2d = decoding.decoding_cpp.cpp_beam_search_2d_by_row(self.model.log_prob, self.model.log_prob, envelope_ranges.tolist())
        self.assertTrue(result_1d == result_2d)
