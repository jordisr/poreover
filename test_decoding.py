...
from decoding import forward, pair_prefix_search, pair_gamma, prefix_search, pair_prefix_search_log, prefix_search_log
...
class TestDecodingLog(unittest.TestCase):
    ...
    def test_prefix_search_log(self):
        ...
        def helper(y):
            ...
            prof = profile(y,alphabet)
            top_label = prof.top_label()
            search_top_label = prefix_search_log(y,alphabet=toy_alphabet)
...
class TestPairDecodingLog(unittest.TestCase):
    ...
    def test_pair_prefix_search_log(self):
        def helper(y1,y2):
            ...
            top_label = joint_prof.top_label()
            search_top_label = pair_prefix_search_log(y1,y2,alphabet=toy_alphabet)
